...
R-10J is a focused masterdata UI behavior change. It uses Element Plus tree-select capability inside the existing shared `ruoyi-ui/src/views/masterdata/index.vue` page and does not create shared frontend controls or modify RuoYi system/tool UI code.

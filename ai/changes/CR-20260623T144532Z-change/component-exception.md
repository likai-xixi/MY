...
This customer-management mobile-phone validation iteration does not create customer-local reusable frontend components. It only updates validation rules in the existing customer screen and reuses Element Plus/RuoYi page conventions already present in `ruoyi-ui/src/views/customer/index.vue`.

...
This customer-management iteration does not create customer-local reusable frontend components. It only changes the existing customer screen and reuses Element Plus/RuoYi page conventions already present in `ruoyi-ui/src/views/customer/index.vue`.

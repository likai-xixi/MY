...
This customer-management validation iteration stays inside the existing `customer` RuoYi feature boundary. It updates the existing customer screen validation, customer service save validation, customer feature brief, customer UI contract, and change/memory evidence.

...
The `customer` implementation does not import other feature internals. It uses only `@/api/customer` on the frontend and the customer controller/service boundary on the backend.
